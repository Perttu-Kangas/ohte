...
class InstructionsView:
    ...
    def initialize(self):
        ...
        move_label = ttk.Label(
            master=self.frame, text="1. Liikuminen tapahtuu nuolinäppäimillä")
        points_label = ttk.Label(
            master=self.frame, text="2. Pisteitä saa syömällä omenoita")
        border_label = ttk.Label(
            master=self.frame, text="3. Osuessa reunaan tai matoon peli loppuu")
